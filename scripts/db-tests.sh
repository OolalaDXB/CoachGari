...
cd "$(dirname "$0")/.."
status=0
for f in supabase/tests/cg002_booking.sql supabase/tests/cg003_payments.sql supabase/tests/cg0025_permissions.sql supabase/tests/cg009_crm.sql supabase/tests/cg010_privacy.sql; do
