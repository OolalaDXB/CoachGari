...
check('consent imports clientIp from the shared module and defines none of its own', /from "\.\.\/_shared\/client-ip\.ts"/.test(consent) && /const ip = clientIp\(req\)/.test(consent) && !/function clientIp\(/.test(consent));
